...
@Component
public class BCryptWorkFactorService {
    ...
    private BCryptWorkFactor calculateStrengthDivideAndConquer(BCryptWorkFactor smallFactor, BCryptWorkFactor bigFactor) {
        ...
        int midStrength = (bigFactor.getStrength() - smallFactor.getStrength()) / 2 + smallFactor.getStrength();
    ...
    private BCryptWorkFactor getClosestStrength(BCryptWorkFactor smallFactor, BCryptWorkFactor bigFactor) {
